...
<div class="col-md-6">
  ...
  <p class='text-center'>Set 100,000 strings <small>(blue new implementation)</small></p>
</div>
<div class="col-md-6">
  <img src="/img/result_100_000_aref.yml-graph.png" alt="Graph fetch 100,000 elements" class="img-responsive figure-img img-fluid"/>
  <p class='text-center'>Fetch 100,000 strings <small>(blue new implementation)</small></p>
</div>
...
[Charles Nutter](https://github.com/headius) also did some benchmarks which indicate that this patch will also help to improve the performance on [Graal JIT](https://en.wikipedia.org/wiki/GraalVM) in the future. We will see! Oh, and the code is already merged upstream and will most likely included in the next JRuby release (9.2.1.0).
